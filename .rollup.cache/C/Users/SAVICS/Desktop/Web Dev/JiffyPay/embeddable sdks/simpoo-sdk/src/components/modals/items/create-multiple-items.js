...
function CreateMuiltipleItems({ isOpen, onClose }) {
  ...
  useEffect(() => {
    const label =
      itemTypesList.find((type) => type?.value === selectedTypes)?.label || "";
  ...
  return _jsxs(ModalLayout, {
    ...
    children: [
      _jsxs("div", {
        className: "px-5 space-y-7 pb-5",
        children: [
          _jsxs("div", {
            className: "grid grid-cols-3 gap-5 bg-gray-100 rounded-xl p-4",
            children: [
              _jsx(Select, {
                label: "Item type",
          ...
          _jsxs("div", {
            ...
            children: [
              _jsxs("table", {
                className: "table-auto w-full border-separate border-spacing-4",
                children: [
                  _jsx("thead", {
                    children: _jsx("tr", {
                      children: tableHead.map((head, index) =>
                        _jsx(
                          "th",
                          {
                            className:
                              "text-dark text-sm font-medium text-left",
                            children: head,
                          },
                          index
                        )
      ...
      _jsxs("div", {
        className:
          "flex justify-between items-center px-5 sticky bottom-0 bg-white py-5 border-t ",
        children: [
          _jsxs("button", {
            className:
              "text-primary text-sm font-medium flex items-center gap-1",
            children: [icons.question, " Need help?"],
          }),
          _jsxs("div", {
