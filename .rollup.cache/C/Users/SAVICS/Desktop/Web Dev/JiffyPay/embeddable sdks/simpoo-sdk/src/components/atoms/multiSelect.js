...
export function MultipleSelector({ placeholder, searchPlaceholder, options = [], showMultiSelectValues = true, values, onChange, className, showCheckMark = true, label, labelClass, required, info, optional, actionLabel, actionLabelAction, actionLabelInfo, removeSelectedValue, removeTag, loading, showCount, error, showError, onChangeSearch, searching, contentStyle, disabled, }) {
                                            ...
                                            : !showMultiSelectValues && showCount && values.length > 0
                                                ...
                                                : placeholder ?? "Select..." }), _jsx(ChevronsUpDown, { className: "ml-2 h-4 w-4 shrink-0 opacity-50" })] }) }), _jsx(PopoverContent, { align: "start", style: { width: sourceWidth }, className: cn("w-[480px] p-0 bg-white rounded-xl border-gray-200", contentStyle), children: _jsx(ScrollArea, { children: _jsxs(Command, { children: [_jsx(CommandInput, { onChangeCapture: onChangeSearch, className: "placeholder:text-xs", placeholder: searchPlaceholder ?? "Search..." }), searching ? (_jsx("div", { className: "flex flex-col gap-2 p-2", children: [1, 2, 3].map((_, index) => (_jsx(Skeleton, { className: "h-9 rounded-md" }, index))) })) : (_jsx(CommandEmpty, { children: "No result found." })), _jsx(CommandGroup, { children: _jsx(CommandList, { className: "", children: options?.map((option) => (_jsxs(CommandItem, { value: typeof option.label === "string"
                                                        ...
                                                        // setOpen(false);
                                                                ...
                                                                ? "opacity-100"
                                                                : "opacity-0") })), option.label] }, option.value))) }) })] }) }) })] })] })) }));
}
